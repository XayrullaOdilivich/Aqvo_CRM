...
const updateShops = async (id) => {
    try {
        const updatedData = {
            address: selectedShops.value.address,
            name: selectedShops.value.name,
            phone: selectedShops.value.phone
        };
            ...
            <div class="modal-content">
                <div class="form">
                    ...
                    <input
                        ...
                        required
                    >
                    <button @click="updateShops" class="btn btn-primary">Yuborish</button>
                </div>
            </div>
        </div>
                ...
                <div class="table-container">
                    <table class="table table-hover">
                        ...
                        <tr v-for="(shops, idx) in shops" :key="shops.id">
                            ...
                            <td>{{ shops.phone }}</td>
                            <td>
                                <button class="update" @click="updateModal(shops)">
